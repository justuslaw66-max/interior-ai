...
const CABINET_PRESET_OPTION_CORES: CabinetPresetOptionCore[] = [
  ...
  { id: "hobby_storage", label: names.hobby_storage, category: "Home office", description: "Tall organised storage with trays for craft or hobby supplies.", difficulty: "Guided", estimatedMinutes: 6, host: "Floor", keywords: ["craft", "hobby", "trays"] },
