...
const DAWSON_MODEL_SELECTOR_IDS = [
  "sofa-real-castlery-dawson-3s",
  "sofa-real-castlery-dawson-extended-sofa",
  "sofa-real-castlery-dawson-ottoman",
  "sofa-real-castlery-dawson-storage-ottoman",
...
const AUBURN_MODEL_FAMILY_IDS = [
  "sofa-real-castlery-auburn-performance-fabric-3-seater-sofa",
  "sofa-real-castlery-auburn-performance-fabric-3-seater-sofa-with-ottoman",
  "sofa-real-castlery-auburn-performance-fabric-extended-3-seater-sofa",
  "sofa-real-castlery-auburn-performance-fabric-extended-3-seater-sofa-with-ottoman",
  "sofa-real-castlery-auburn-performance-fabric-curve-3-seater-sofa",
  "sofa-real-castlery-auburn-performance-fabric-curve-3-seater-sofa-with-ottoman",
  "sofa-real-castlery-auburn-performance-fabric-armless-curve-3-seater-sofa",
  "sofa-real-castlery-auburn-performance-fabric-armless-curve-3-seater-sofa-with-ottoman",
  ...
  "sofa-real-castlery-auburn-performance-fabric-sectional-sofa",
  "sofa-real-castlery-auburn-performance-fabric-sectional-sofa-with-ottoman",
  "sofa-real-castlery-auburn-performance-fabric-curve-l-shape-sectional-sofa",
  "sofa-real-castlery-auburn-performance-fabric-curve-l-shape-sectional-sofa-with-ottoman",
  "sofa-real-castlery-auburn-performance-fabric-l-shape-sectional-sofa",
  "sofa-real-castlery-auburn-performance-fabric-l-shape-sectional-sofa-with-ottoman",
];
    ...
    options: [
      {
        ...
        diagram: "standard-3-seater",
        productId: "sofa-real-castlery-auburn-performance-fabric-3-seater-sofa",
      },
      {
        ...
        productId: "sofa-real-castlery-auburn-performance-fabric-3-seater-sofa-with-ottoman",
      },
      {
        key: "extended-3-seater",
        ...
        diagram: "standard-extended-3-seater",
        productId: "sofa-real-castlery-auburn-performance-fabric-extended-3-seater-sofa",
      },
      {
        ...
        productId: "sofa-real-castlery-auburn-performance-fabric-extended-3-seater-sofa-with-ottoman",
      },
    ],
  },
  {
    ...
    options: [
      {
        ...
        productId: "sofa-real-castlery-auburn-performance-fabric-curve-3-seater-sofa",
      },
      {
        ...
        productId: "sofa-real-castlery-auburn-performance-fabric-curve-3-seater-sofa-with-ottoman",
      },
      {
        ...
        productId: "sofa-real-castlery-auburn-performance-fabric-armless-curve-3-seater-sofa",
      },
      {
        ...
        productId: "sofa-real-castlery-auburn-performance-fabric-armless-curve-3-seater-sofa-with-ottoman",
      },
    ],
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        diagram: "sectional",
        productId: "sofa-real-castlery-auburn-performance-fabric-sectional-sofa",
      },
      {
        ...
        productId: "sofa-real-castlery-auburn-performance-fabric-sectional-sofa-with-ottoman",
      },
      {
        ...
        productId: "sofa-real-castlery-auburn-performance-fabric-curve-l-shape-sectional-sofa",
      },
      {
        ...
        productId: "sofa-real-castlery-auburn-performance-fabric-curve-l-shape-sectional-sofa-with-ottoman",
      },
      {
        ...
        productId: "sofa-real-castlery-auburn-performance-fabric-l-shape-sectional-sofa",
      },
      {
        ...
        productId: "sofa-real-castlery-auburn-performance-fabric-l-shape-sectional-sofa-with-ottoman",
      },
    ],
  },
];
...
export const MODEL_FAMILY_BY_PRODUCT_ID: Record<string, string[]> = {
  ...
  ...Object.fromEntries(DAWSON_MODEL_FAMILY_IDS.map((id) => [id, [...DAWSON_MODEL_FAMILY_IDS]])),
...
export const MODEL_SELECTOR_PRODUCT_IDS_BY_PRODUCT_ID: Record<string, string[]> = {
  ...
  ...Object.fromEntries(DAWSON_MODEL_FAMILY_IDS.map((id) => [id, [...DAWSON_MODEL_SELECTOR_IDS]])),
  "sofa-real-castlery-jaron-3s": [...JARON_MODEL_FAMILY_IDS],
  "sofa-real-castlery-jaron-3s-wide-arm": [...JARON_MODEL_FAMILY_IDS],
  "sofa-real-castlery-jaron-extended-3s": [...JARON_MODEL_FAMILY_IDS],
  "sofa-real-castlery-jaron-extended-3s-wide-arm": [...JARON_MODEL_FAMILY_IDS],
...
export const MODEL_SELECTOR_REPRESENTATIVE_BY_PRODUCT_ID: Record<string, string> = {
  ...
  "sofa-real-castlery-hamilton-chaise-sectional-sofa-bed-right": "sofa-real-castlery-hamilton-chaise-sectional-sofa-bed-left",
  "sofa-real-castlery-dawson-wide-chaise-sectional": "sofa-real-castlery-dawson-wide-chaise-sectional-left",
  "sofa-real-castlery-dawson-chaise-sectional": "sofa-real-castlery-dawson-chaise-sectional-left",
};
...
> = {
  ...Object.fromEntries([
    ...
    ["sofa-real-castlery-hamilton-chaise-sectional-sofa-bed-left", "sofa-real-castlery-hamilton-chaise-sectional-sofa-bed-right"],
