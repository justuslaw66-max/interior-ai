...
| CH-0017 | P1, reopened | REOPENED | The Outcome-C correction is at 53a0c98; a separate local workflow follow-up keeps required PR checks automatic while making the two-hour advisory inventory deliberate. Exact-head external execution and enforcement remain unverified. |
