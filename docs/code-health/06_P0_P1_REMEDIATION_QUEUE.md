...
| CH-0017 | P1, resolved/frozen | RESOLVED | TRUTHFULNESS AND REQUIRED EXTERNAL WORKFLOW VERIFIED — IMPLEMENTATION FROZEN at `b06714267b35203185fdd5ba1c189ab74933ffc7`. |
...
| CH-0028 | P1 release/runtime | OPEN | Combined required-only external verification is pending after integrating the verified CH-0017 boundary provenance with the atomic metadata-only lifecycle/cache/refcount snapshot. Local evidence does not mark this finding externally verified. |
| CH-0029 | P2 performance | OPEN | End-to-end reload and main-thread scheduling performance remains separately tracked. The explicit 70,000 ms reload performance threshold is non-failing and unchanged. |
