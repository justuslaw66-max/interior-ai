...
| CH-0017 | P1, reopened | REOPENED | Exact-head `d295e98` verified the frozen workflow/evidence controls through required runtime execution, then truthfully exposed an invalid 70-second reload phase contract. The systematic 14-phase budget/progress correction is in the commit containing this record; a new exact-head run and enforcement recheck remain required. |
