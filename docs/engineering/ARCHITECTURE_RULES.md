...
- `lib/room-floor-area` is the single owner of room floor and ceiling area (a custom polygon with at least three points replaces width × depth, and holes are subtracted), read by the export bill of materials, the editor Surface Summary and the plan room summary.
