...
- `lib/floor-plan-calibration.ts` — Defines `measureFloorPlanPointDistanceMeters`, `mapUnderlayWorldPointToPixels`, `applyFloorPlanScaleCalibration`, `formatFloorPlanCalibrationSummary` for floor plan calibration.
