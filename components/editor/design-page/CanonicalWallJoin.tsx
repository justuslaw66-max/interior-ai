...
export function CanonicalWallJoin({ floor, wall, commit }: {
  ...
  return <details><summary className="cursor-pointer font-semibold">Join an endpoint</summary>
    <p className="my-2">Connect a free endpoint to an existing wall corner or an exact point on a wall centreline. The join preserves one shared corner; an opening crossing a required split blocks the change.</p>
    <div className="grid grid-cols-2 gap-2">
      ...
      {!enabled && <p className="col-span-2 text-amber-700">Choose a free endpoint of a wall. An existing room corner or shared junction cannot be joined by this tool.</p>}
