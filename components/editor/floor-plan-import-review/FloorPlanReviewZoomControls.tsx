...
export function FloorPlanReviewZoomControls({ zoom, setZoom, pages, pageNumber, onPageNumberChange, dark }: {
  ...
  return <div className="flex flex-wrap items-center justify-end gap-1 text-[10px]">
    ...
    {pages.length > 1 ? <select aria-label="Floor plan page" className={dark ? "designer-control rounded border px-1 py-1 text-[10px]" : "rounded border border-neutral-300 bg-white px-1 py-1 text-[10px]"}
