...
const typescriptGuardFiles = [
  ...
  "test-design-page-download.tsx",
  "test-design-page-editor-registration.ts",
  ...
  "test-design-page-local-backup.ts",
  ...
  "test-design-page-share-link.ts",
  "test-design-page-viewport-workspace-read-model.ts",
