...
const compiler = webpack({
  ...
  entry: path.join(
    ...
    "required",
    "fixtures",
    "guest-save-checkout-harness.tsx"
  ),
  output: {
    path: outputPath,
    filename: "bundle.js",
...
if (!existsSync(outputFile)) {
  throw new Error("Guest Save checkout browser fixture bundle is missing");
}

console.log("Guest Save checkout browser fixture bundle prepared.");
