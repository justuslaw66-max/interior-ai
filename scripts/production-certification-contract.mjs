...
export const CERTIFICATION_HARNESS_SOURCE_PATHS = Object.freeze([
  ...
  "scripts/stable-runtime-smoke.mjs",
  "scripts/stable-runtime-smoke-database-transport.mjs",
  "scripts/stable-runtime-smoke-resources.mjs",
  ...
  "scripts/test-production-certification-browser-server-lifecycle.mjs",
  ...
  "scripts/test-production-certification-database-cleanup-observation.mjs",
  "scripts/production-certification-database-transport-contract.mjs",
